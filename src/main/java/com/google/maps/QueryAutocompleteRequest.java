...
/**
 * A <a href=
 * "https://developers.google.com/places/web-service/query#query_autocomplete_requests">Query
 * Autocomplete</a> request.
 */
public class QueryAutocompleteRequest extends
		PendingResultBase<AutocompletePrediction[], QueryAutocompleteRequest, QueryAutocompleteRequest.Response> {
	...
	/**
	 * The text string on which to search. The Places service will return candidate
	 ...
	 *
	 * @param offset
	 *            The character offset to search from.
	 * @return Returns this {@code QueryAutocompleteRequest} for call chaining.
	 */
	 ...
	 *
	 * @param location
	 *            The location point around which to search.
	 * @return Returns this {@code QueryAutocompleteRequest} for call chaining.
	 */
	 ...
	 *
	 * @param radius
	 *            The radius around which to bias results.
	 * @return Returns this {@code QueryAutocompleteRequest} for call chaining.
	 */

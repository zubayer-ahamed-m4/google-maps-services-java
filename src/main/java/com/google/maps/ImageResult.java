...
/**
 * {@code ImageResult} is the object returned from API end points that return
 * images.
 */
public class ImageResult implements Serializable {
	...
	/**
	 * <code>ImageResult.Response</code> is a type system hack to enable API
	 * endpoints to return a <code>ImageResult</code>.
	 */

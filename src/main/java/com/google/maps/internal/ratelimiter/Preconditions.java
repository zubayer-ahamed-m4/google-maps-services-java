 ...
 *
 * <p>
 * This is a minimal port of Google Guava's com.google.common.base.Preconditions
 * necessary to implement the ratelimiter classes.
 */
public final class Preconditions {
	 ...
	 *
	 * @param template
	 *            a string containing 0 or more {@code %s} placeholders. null is
	 *            treated as "null".
	 * @param args
	 *            the arguments to be substituted into the message template.
	 *            Arguments are converted to strings using

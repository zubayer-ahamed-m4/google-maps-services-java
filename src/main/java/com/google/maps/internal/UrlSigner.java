 ...
 * <p>
 * See <a href=
 * "https://developers.google.com/maps/documentation/directions/get-api-key#client-id">Using
...
public class UrlSigner {
	...
	public UrlSigner(final String keyString) throws NoSuchAlgorithmException, InvalidKeyException {
		...
		if (decodedKey == null) {
			// NOTE: don't log the exception, in case some of the private key leaks to an
			// end-user.

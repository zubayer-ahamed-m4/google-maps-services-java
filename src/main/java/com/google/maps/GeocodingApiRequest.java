...
public class GeocodingApiRequest
	...
	protected void validateRequest() {
		...
		if (!params().containsKey("latlng") && !params().containsKey("address") && !params().containsKey("components")
	...
	/**
	 * Sets the bounding box of the viewport within which to bias geocode results
	 * more prominently. This parameter will only influence, not fully restrict,
	 * results from the geocoder.
	 *
	 * <p>
	 * For more information see <a href=
	 * "https://developers.google.com/maps/documentation/geocoding/intro?hl=pl#Viewports">
	 * Viewport Biasing</a>.
	 *
	 * @param southWestBound
	 *            The South West bound of the bounding box.
	 * @param northEastBound
	 *            The North East bound of the bounding box.
	 * @return Returns this {@code GeocodingApiRequest} for call chaining.
	 */
	...
	/**
	 * Sets the region code, specified as a ccTLD ("top-level domain") two-character
	 * value. This parameter will only influence, not fully restrict, results from
	 * the geocoder.
	 *
	 * <p>
	 * For more information see <a href=
	 * "https://developers.google.com/maps/documentation/geocoding/intro?hl=pl#RegionCodes">Region
	 * Biasing</a>.
	 *
	 * @param region
	 *            The region code to influence results.
	 * @return Returns this {@code GeocodingApiRequest} for call chaining.
	 */
	...
	/**
	 * Sets the component filters. Each component filter consists of a
	 * component:value pair and will fully restrict the results from the geocoder.
	 *
	 * <p>
	 * For more information see <a href=
	 ...
	 *
	 * @param filters
	 *            Component filters to apply to the request.
	 * @return Returns this {@code GeocodingApiRequest} for call chaining.
	 */
	...
	/**
	 * Sets the result type. Specifying a type will restrict the results to this
	 * type. If multiple types are specified, the API will return all addresses that
	 * match any of the types.
	 *
	 * @param resultTypes
	 *            The result types to restrict to.
	 * @return Returns this {@code GeocodingApiRequest} for call chaining.
	 */
	...
	/**
	 * Sets the location type. Specifying a type will restrict the results to this
	 * type. If multiple types are specified, the API will return all addresses that
	 * match any of the types.
	 *
	 * @param locationTypes
	 *            The location types to restrict to.
	 * @return Returns this {@code GeocodingApiRequest} for call chaining.
	 */

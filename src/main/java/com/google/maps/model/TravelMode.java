 ...
 * Directions are calculating as driving directions by default.
 *
 * @see <a href=
 *      "https://developers.google.com/maps/documentation/directions/intro#TravelModes">
 *      Directions API travel modes</a>
 * @see <a href=
 *      "https://developers.google.com/maps/documentation/distance-matrix/intro">Distance
 *      Matrix API Intro</a>
 */
public enum TravelMode implements UrlValue {
	...
	/**
	 * Indicates an unknown travel mode returned by the server. The Java Client for

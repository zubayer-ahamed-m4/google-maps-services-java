...
/**
 * A component filter for a geocode request. In a geocoding response, the Google
 * Geocoding API can return address results restricted to a specific area. The
 * restriction is specified using the components filter.
 *
 * <p>
 * Please see <a href=
 * "https://developers.google.com/maps/documentation/geocoding/intro#ComponentFiltering">Component
...
public class ComponentFilter implements StringJoin.UrlValue {
	 ...
	 *
	 * @param route
	 *            The name of the route to filter on.
	 ...
	 *            The administrative area to filter on.
	 * @return Returns a {@link ComponentFilter}.
	 */

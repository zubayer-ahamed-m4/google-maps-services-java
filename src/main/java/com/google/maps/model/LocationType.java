...
/**
 * Location types for a reverse geocoding request. Please see <a href=
 * "https://developers.google.com/maps/documentation/geocoding/start#reverse">Reverse
...
public enum LocationType implements UrlValue {
	...
	/**
	 * Restricts the results to those that reflect an approximation (usually on a
	 * road) interpolated between two precise points (such as intersections). An
	...
	/**
	 * Restricts the results to geometric centers of a location such as a polyline
	...
	/**
	 * Indicates an unknown location type returned by the server. The Java Client

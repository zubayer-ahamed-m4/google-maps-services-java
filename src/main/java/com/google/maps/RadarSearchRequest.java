...
public class RadarSearchRequest
	...
	/**
	 * The distance (in meters) within which to return place results. The maximum
	 * allowed radius is 50,000 meters. Note that radius must not be included if
	 * rankby=DISTANCE is specified.
	 *
	 * @param distance
	 *            The radius distance to restrict results.
	 * @return Returns this {@code RadarSearchRequest} for call chaining.
	 */
	 ...
	 *
	 * @param priceLevel
	 *            The minimum price level to restrict results with.
	 * @return Returns this {@code RadarSearchRequest} for call chaining.
	 */
	 ...
	 *
	 * @param priceLevel
	 *            The maximum price level to restrict results with.
	 * @return Returns this {@code RadarSearchRequest} for call chaining.
	 */
	...
	/**
	 * One or more terms to be matched against the names of places, separated with
	 * space characters.
	 *
	 * @param name
	 *            The name to restrict results with.
	 * @return Returns this {@code RadarSearchRequest} for call chaining.
	 */
	...
	/**
	 * Restricts the results to only those places that are open for business at the
	 * time the query is sent.
	 *
	 * @param openNow
	 *            Whether to restrict to results that are open now.
	 * @return Returns this {@code RadarSearchRequest} for call chaining.
	 */
	 ...
	 *
	 * @param type
	 *            The Place Type to restrict results to.
	 * @return Returns this {@code RadarSearchRequest} for call chaining.
	 */
	...
	protected void validateRequest() {
		if (!params().containsKey("keyword") && !params().containsKey("name") && !params().containsKey("type")) {

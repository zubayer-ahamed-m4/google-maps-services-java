...
public class DistanceMatrixApiRequest extends PendingResultBase<DistanceMatrix, DistanceMatrixApiRequest, Response> {
	...
	/**
	 * One or more addresses from which to calculate distance and time. The service
	 * will geocode the strings and convert them to latitude/longitude coordinates
	 * to calculate directions.
	 *
	 * @param origins
	 *            Strings to geocode and use as an origin point (e.g. "New York,
	 *            NY")
	...
	/**
	 * One or more latitude/longitude values from which to calculate distance and
	 * time.
	 *
	 * @param points
	 *            The origin points.
	...
	/**
	 * One or more addresses to which to calculate distance and time. The service
	 * will geocode the strings and convert them to latitude/longitude coordinates
	 * to calculate directions.
	 *
	 * @param destinations
	 *            Strings to geocode and use as a destination point (e.g. "Jersey
	 *            City, NJ")
	 * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
	 */
	...
	/**
	 * One or more latitude/longitude values to which to calculate distance and
	 * time.
	 *
	 * @param points
	 ...
	 *
	 * <p>
	 * Note that Distance Matrix requests only support {@link TravelMode#DRIVING},
	 * {@link TravelMode#WALKING} and {@link TravelMode#BICYCLING}.
	 *
	 * @param mode
	 *            One of the travel modes supported by the Distance Matrix API.
	 * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
	 */
	 ...
	 *
	 * @param restriction
	 *            One of {@link RouteRestriction#TOLLS},
	 *            {@link RouteRestriction#FERRIES} or
	...
	/**
	 * Specifies the unit system to use when expressing distance as text. Distance
	 * Matrix results contain text within distance fields to indicate the distance
	 * of the calculated route.
	 *
	 * @param unit
	 *            One of {@link Unit#METRIC} or {@link Unit#IMPERIAL}.
	 * @see <a href=
	 ...
	 *
	 * <ul>
	 * <li>For requests where the travel mode is transit: You can optionally specify
	 * one of departure_time or arrival_time. If neither time is specified, the
	 * departure_time defaults to now. (That is, the departure time defaults to the
	 * current time.)
	 * <li>For requests where the travel mode is driving: Google Maps API for Work
	 * customers can specify the departure_time to receive trip duration considering
	 * current traffic conditions. The departure_time must be set to within a few
	 ...
	 * parameter may only be specified when the travel mode is driving and the
	 * request includes a departure_time.
	 *
	 * @param trafficModel
	 *            The traffic model to use in estimating time in traffic.
	 * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
	 */
	...
	/**
	 * Specifies the desired time of arrival for transit requests. You can specify
	 * either departure_time or arrival_time, but not both.
	 *
	 * @param arrivalTime
	 ...
	 *
	 * @param pref
	 *            The transit routing preference for this distance matrix.
	 * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
	 */

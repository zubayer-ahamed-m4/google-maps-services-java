...
public class PlacesApi {
	...
	/**
	 * Performs a radar search for up to 200 places, but with less detail than is
	 * returned from Text Search or Nearby Search.
	 *
	 * @deprecated This functionality is deprecated and will stop working on June
	 *             30, 2018.
	 * @see <a href=
	 *      "https://maps-apis.googleblog.com/2017/06/announcing-deprecation-of-place-add.html">Removing

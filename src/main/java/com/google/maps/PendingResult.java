...
public interface PendingResult<T> {
	 ...
	 * {@link com.google.maps.PendingResult.Callback#onResult onResult} or
	 * {@link com.google.maps.PendingResult.Callback#onFailure onFailure} after the
	 ...
	 * @return The result.
	 * @throws ApiException
	 *             Thrown if the API Returned result is an error.
	...
	/**
	 * Performs the request synchronously, ignoring exceptions while performing the
	 * request and errors returned by the server.
	 *
	...
	/**
	 * The callback interface the API client code needs to implement to handle API
	 * results.
	 *
	 * @param <T>
	 *            The type of the result object.

...
/**
 * A <a href=
 * "https://developers.google.com/places/web-service/photos#place_photo_requests">Place
 * Photo</a> request.
 */
public class PhotoRequest extends PendingResultBase<ImageResult, PhotoRequest, ImageResult.Response> {
	 ...
	 *            A string identifier that uniquely identifies a photo. Photo
	 *            references are returned from either a Place Search or Place
	 *            Details request.
	 ...
	 *
	 * @param maxHeight
	 *            The maximum desired height, in pixels, of the image returned by
	 *            the Place Photos service.
	 * @return Returns the configured PhotoRequest.
	 */
	 ...
	 *
	 * @param maxWidth
	 *            The maximum desired width, in pixels, of the image returned by the

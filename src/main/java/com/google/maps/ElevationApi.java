...
/**
 * The Google Elevation API provides a simple interface to query locations on
 * the earth for elevation data. Additionally, you may request sampled elevation
 * data along paths, allowing you to calculate elevation changes along routes.
 *
 * <p>
 * See <a href=
 * "https://developers.google.com/maps/documentation/elevation/start">the Google
 * Maps Elevation API documentation</a>.
 */
public class ElevationApi {
	 ...
	 * @param points
	 *            The points to retrieve elevations for.
	 ...
	 *            The {@link GeoApiContext} to make requests through.
	 * @param samples
	 *            The number of samples to retrieve heights along {@code path}.
	 * @param path
	 *            The path to sample.
	 * @return The elevations as a {@link PendingResult}.
	 */
	public static PendingResult<ElevationResult[]> getByPath(GeoApiContext context, int samples, LatLng... path) {
		return context.get(API_CONFIG, MultiResponse.class, "samples", String.valueOf(samples), "path",
				shortestParam(path));
	}
	 ...
	 *            The {@link GeoApiContext} to make requests through.
	 * @param samples
	 *            The number of samples to retrieve heights along
	 *            {@code encodedPolyline}.
	 * @param encodedPolyline
	 *            The path to sample as an encoded polyline.
	 * @return The elevations as a {@link PendingResult}.
	 */
	public static PendingResult<ElevationResult[]> getByPath(GeoApiContext context, int samples,
	...
	/**
	 * Chooses the shortest param (only a guess, since the length is different after
	 * URL encoding).
	 */
	 ...
	 *            The {@link GeoApiContext} to make requests through.
	 * @param location
	 *            The location to retrieve the elevation for.
	 ...
	 *            The {@link GeoApiContext} to make requests through.
	 * @param encodedPolyline
	 *            The encoded polyline to retrieve elevations for.
	 * @return The elevations as a {@link PendingResult}.
	 */

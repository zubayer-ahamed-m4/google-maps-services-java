...
/**
 * A <a href=
 * "https://developers.google.com/places/web-service/search#TextSearchRequests">Text
 * Search</a> request.
 */
public class TextSearchRequest
	 ...
	 *
	 * @param location
	 *            The location of the center of the search.
	 * @return Returns this {@code TextSearchRequest} for call chaining.
	 */
	 ...
	 *
	 * @param priceLevel
	 *            The maximum price leve to restrict results with.
	 * @return Returns this {@code TextSearchRequest} for call chaining.
	 */
	 ...
	 *
	 * @param openNow
	 *            Whether to restrict this search to open places.
	 * @return Returns this {@code TextSearchRequest} for call chaining.
	 */
	...
	/**
	 * Returns the next 20 results from a previously run search. Setting pageToken
	 * will execute a search with the same parameters used previously — all
	 * parameters other than pageToken will be ignored.
	 *
	 * @param nextPageToken
	 *            A {@code pageToken} from a prior result.
	 * @return Returns this {@code TextSearchRequest} for call chaining.
	 */
	 ...
	 *
	 * @param type
	 *            The type of place to restrict the results with.
	 * @return Returns this {@code TextSearchRequest} for call chaining.
	 */

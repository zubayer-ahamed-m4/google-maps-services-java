...
/**
 * ApiException and its descendants represent an error returned by the remote
 * API. API errors are determined by the {@code status} field returned in any of
 * the Geo API responses.
 */
public class ApiException extends Exception {
	...
	/**
	 * Construct the appropriate ApiException from the response. If the response was
	 * successful, this method will return null.
	 *
	 * @param status
	 *            The status field returned from the API
	 * @param errorMessage
	 *            The error message returned from the API
	 * @return The appropriate ApiException based on the status or null if no error
	 *         occurred.
	 */
